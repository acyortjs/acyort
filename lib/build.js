...
function Build(data) {
    ...
    Object.keys(categories).forEach((category) => {
        categories[category].forEach(page => render(page.path, template.category, Object.assign({ page }, helper)))
    })

    Object.keys(tags).forEach((tag) => {
        tags[tag].forEach(page => render(page.path, template.tag, Object.assign({ page }, helper)))
    })
}
